...
Para hacer la comparativa, primero explicaré brevemente lo que leí en el libro ``Fundamentals of Database Systems'' \cite{FDS-Elmasri-Navathe} y las notas de clase \cite{01ConceptosBasicos} sobre cómo podemos clasificar los SMBD y qué significa cada uno:
